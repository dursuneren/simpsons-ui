  ...
  return (
    <nav className="bg-simpsons-blue border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-simpsons-blue-dark">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div
          className={
            "w-full md:block md:w-auto " + (isOpen ? "show" : "hidden")
          }
          id="mobile-menu"
        >
          <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium items-center">
            {/* Switcher */}
            <li>
              <div className="block py-2 pr-3 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white">
                <Switcher />
              </div>
            </li>
          </ul>
